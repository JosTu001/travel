    ...
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen}">
        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full pb-16 overflow-y-auto">
                <!-- THÊM TUYẾN -->
                <form action="themBX.php" method="post">
                    <div class="container grid px-6 mx-auto">
                        ...
                        <div class="px-6 my-6">
                            ...
                            <!-- <input type="hidden" name="TC_Ma" value="<?php //echo $row['LX_Ma']; ?>" /> -->
                        </div>
                </form>
                        ...
                        <table class="w-full whitespace-no-wrap">
                            <thead>
                                <tr class=" text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                    ...
                                    <th class="px-4 py-3 " style="width: 15%">Mã bến xe</th>
                                    <th class="px-4 py-3" style="width: 30%">Tên bến xe</th>
                                    <th class="px-4 py-3" style="width: 40%">Địa Chỉ</th>
                            ...
                            // $sql = "SELECT * FROM loaixe where LX_Ten LIKE '%$noidung%' or LX_SLGhe LIKE '%$noidung%'";
                            // $query = mysqli_query($conn, $sql);
                            
                            $item_per_page = !empty($_GET['per_page'])?$_GET['per_page']:10;
                            $current_page = !empty($_GET['page'])?$_GET['page']:1; //Trang hiện tại
                            $offset = ($current_page - 1) * $item_per_page;
                            $products = mysqli_query($conn, "SELECT * FROM benxe a, quanhuyen b, tinhthanh c where a.H_Ma = b.H_Ma and b.T_Ma = c.T_Ma and (BX_Ten LIKE '%$noidung%' or a.H_Ma LIKE '%$noidung%')  LIMIT " . $item_per_page . " OFFSET " . $offset);
                            $totalRecords = mysqli_query($conn, "SELECT * FROM benxe ");
                                ...
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3">
                                            ...
                                            <form action="suaBX.php" method="post">
                                                    <!-- <a class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Xoa" href="xoaLX.php?this_id=<?php echo $row['BX_Ma'] ?> ">
                                                    <i class="fa-solid fa-trash-can"></i>

                                                    </a> -->
                                                    <input type="hidden" name="BX_Ma" value="<?php echo $row['BX_Ma']; ?>" />
                                                    <input type="hidden" name="ten" value="<?php echo $row['BX_Ten']; ?>" />
                                                    <button class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" type="submit">  <i class="fa-solid fa-pen"></i></button>
                                                </form>
                                               

                                                <form action="xoaBX.php" method="post">
                                                    <!-- <a class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Xoa" href="xoaLX.php?this_id=<?php echo $row['BX_Ma'] ?> ">
                                                    <i class="fa-solid fa-trash-can"></i>

                                                    </a> -->
                                                    <input type="hidden" name="BX_Ma" value="<?php echo $row['BX_Ma']; ?>" />
                                                    <button  class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" type="submit"> <i style="color: red;" class="fa-solid fa-trash-can"></i></button>
                                                </form>
