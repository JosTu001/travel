    ...
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen}">
        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full pb-16 overflow-y-auto">
                <!-- THÊM TUYẾN -->
                <form action="themLX.php" method="post">
                        ...
                        <table class="w-full whitespace-no-wrap">
                            <thead>
                                <tr class=" text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                    ...
                                    <th class="px-4 py-3 " style="width: 30%">Mã loại xe</th>
                                    <th class="px-4 py-3" style="width: 30%">Tên loại xe</th>
                                    <th class="px-4 py-3" style="width: 30%">Số lượng ghế</th>
                            ...
                            $products = mysqli_query($conn, "SELECT * FROM loaixe where LX_Ten LIKE '%$noidung%' or LX_SLGhe LIKE '%$noidung%' ORDER BY `LX_Ma` ASC  LIMIT " . $item_per_page . " OFFSET " . $offset);
                            $totalRecords = mysqli_query($conn, "SELECT * FROM loaixe ");
                                    ...
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3">
                                            ...
                                            <form action="suaLX.php" method="post">
                                                    <!-- <a class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Xoa" href="xoaLX.php?this_id=<?php echo $row['LX_Ma'] ?> ">
                                                    <i class="fa-solid fa-trash-can"></i>

                                                    </a> -->
                                                    <input type="hidden" name="LX_Ma" value="<?php echo $row['LX_Ma']; ?>" />
                                                    <input type="hidden" name="ten" value="<?php echo $row['LX_Ten']; ?>" />
                                                ...
                                                <form action="xoaLX.php" method="post">
                                                    <!-- <a class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Xoa" href="xoaLX.php?this_id=<?php echo $row['LX_Ma'] ?> ">
                                                    <i class="fa-solid fa-trash-can"></i>
