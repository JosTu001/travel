                ...
                <div class="w-full overflow-hidden rounded-lg shadow-xs">
                    <div class="w-full overflow-x-auto">
                        <table class="w-full whitespace-no-wrap">
                            ...
                            $products = mysqli_query($conn, "SELECT * FROM nhanvien a, vaitro b where a.VT_Ma=b.VT_Ma and (NV_Ten LIKE '%$noidung%' or b.VT_Ten LIKE '%$noidung%' or a.NV_Sdt LIKE '%$noidung%') ORDER BY `NV_Ma` ASC  LIMIT " . $item_per_page . " OFFSET " . $offset);
                            $totalRecords = mysqli_query($conn, "SELECT * FROM nhanvien ");
                                    ...
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center text-sm">
                                                <div>
                                                    <p class="font-semibold"><?php echo $row['NV_Ma']; ?></p>
                                        ...
                                        <td class="px-4 py-3 text-xs">
                                            <?php echo $row['NV_GioiTinh']; ?>
                                        </td>

                                        <!-- GIÁ -->
                                        <td class="px-4 py-3 text-sm">

                                            <?php  $date=date_create($row["NV_NgaySinh"]); echo date_format( $date, "d-m-Y "); ?>
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded-full" src="../img/Xe/ghe/<?php echo $row["NV_Hinh"]; ?>" loading="lazy" />
                                        ...
                                        <td class="px-4 py-3">
                                            ...
                                            <div class="flex items-center space-x-4 text-sm">
                                                <form action="" method="post">
                                                    <a class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Sua" href="capnhatNV.php?this_id=<?php echo $row['NV_Ma'] ?> ">
                                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                                                        </svg>

                                                    </a>
                                                    <input type="hidden" name="NV_Ma" value="<?php echo $row['NV_Ma']; ?>" />
                                                </form>

                                                <!-- XOÁ -->

                                                <form action="" method="post">
                                                    <a style="color: red;" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Xoa" class="btn btn-info btn-sm" href="xoaNV.php?this_id=<?php echo $row['NV_Ma'] ?> ">
