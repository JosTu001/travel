  ...
  <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen}">
    ...
    <div class="flex flex-col flex-1 w-full">
      ...
      <main class="h-full pb-16 overflow-y-auto">
        <!-- THÊM TUYẾN -->
        <form action="themtuyen.php" method="post">
          <div class="container grid px-6 mx-auto">
            ...
            <div class="px-6 my-6">
              ...
              <!-- <input type="hidden" name="TC_Ma" value="<?php echo $row['TC_Ma']; ?>" /> -->
            </div>
        </form>
            ...
            <table class="w-full whitespace-no-wrap" >
              <thead>
                <tr class=" text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                  <th class="px-4 py-3" style="width: 20%">Mã Tuyến</th>
                  <th class="px-4 py-3" style="width: 15%">Thời Gian Tạo</th>
                  <th class="px-4 py-3" style="width: 30%">Tên Tuyến</th>
             ...
             ?>
              ...
              $products = mysqli_query($conn, "SELECT * FROM tuyenchay where TC_Ten LIKE '%$noidung%' ORDER BY `TC_Ma` ASC  LIMIT " . $item_per_page . " OFFSET " . $offset);
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    ...
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        <div>
                          <p class="font-semibold"><?php echo $row['TC_Ma']; ?></p>
                    ...
                    <td class="px-4 py-3">
                      ...
                      <div class="flex items-center text-sm">
                        <div>
                          ...
                          if($row["TC_ThoiGianTao"] == '0000-00-00 00:00:00'){
                            echo '';
                          }else{

                            $date = date_create($row["TC_ThoiGianTao"]);
...
<!-- 
                    ...
                    <!-- <td class="px-4 py-3 text-sm">
                      <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                        <?php //echo number_format($row["TC_Gia"]); ?>
                      </span>
                    </td> -->

                    <!-- MÃ XE -->
                    <!-- <td class="px-4 py-3 text-sm">
                      <?php //echo $row['BXKH_Ma']; ?>
                    </td>
                    <td class="px-4 py-3 text-sm">
                      <?php //echo $row['BXD_Ma']; ?>
                    </td> -->
                            ...
                            <div
                              ...
                              >
                                <img
                                  ...
                                  src="../img/Xe/ghe/<?php echo $row["TC_Hinh"]; ?>"
                                  loading="lazy"
                                />
                                <div
                    ...
                    <td class="px-4 py-3">
                      ...
                      <div class="flex items-center space-x-4 text-sm">
                        <form action="" method="post">
                          <a class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Sua" href="capnhattuyen.php?this_id=<?php echo $row['TC_Ma'] ?> ">
                            <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <form action="" method="post">
                          <a style="color: red;" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Xoa" class="btn btn-info btn-sm" href="xoatuyen.php?this_id=<?php echo $row['TC_Ma'] ?> ">
