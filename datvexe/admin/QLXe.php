                ...
                <form action="themxe.php" method="post">
                    <div class="container grid px-6 mx-auto">
                        ...
                        <div class="px-6 my-6">
                            ...
                            <!-- <input type="hidden" name="TC_Ma" value="<?php echo $row['X_Ma']; ?>" /> -->
                        </div>
                </form>
                        ...
                        <table class="w-full whitespace-no-wrap">
                            <thead>
                                <tr class=" text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                                    <th class="px-4 py-3" style="width: 20%">Mã Xe</th>
                                    <th class="px-4 py-3" style="width: 30%">Biển Số</th>
                                    <th class="px-4 py-3" style="width: 20%">Loại Xe</th>
                                    <th class="px-4 py-3" style="width: 20%">Số Lượng Ghế</th>
                                    <th class="px-4 py-3" style="width: 15%">Hiệu</th>

                                    <th class="px-4 py-3" style="width: 15%">Màu Sắc</th>

                                    <th class="px-4 py-3" style="width: 20%">Năm Sản Xuất</th>
                            ...
                            // $sql = "SELECT * FROM Xe a, loaixe b where a.LX_Ma=b.LX_Ma and a.X_BienSo LIKE '%$noidung%'";
                            // $query = mysqli_query($conn, $sql);
                            $item_per_page = !empty($_GET['per_page'])?$_GET['per_page']:10;
                            $current_page = !empty($_GET['page'])?$_GET['page']:1; //Trang hiện tại
                            $offset = ($current_page - 1) * $item_per_page;
                            $products = mysqli_query($conn, "SELECT * FROM Xe a, loaixe b where a.LX_Ma=b.LX_Ma and a.X_BienSo LIKE '%$noidung%' ORDER BY `X_Ma` ASC  LIMIT " . $item_per_page . " OFFSET " . $offset);
                            $totalRecords = mysqli_query($conn, "SELECT * FROM Xe ");
                                    ...
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center text-sm">
                                                <div>
                                                    <p class="font-semibold"><?php echo $row['X_Ma']; ?></p>
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <span class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                                                <?php echo $row["X_MauSac"]; ?>
                                            </span>
                                        </td>

                                        <!-- MÃ XE -->
                                        <td class="px-4 py-3 text-sm">
                                            <?php   $date=date_create($row["X_NamSX"]); echo date_format( $date, "d-m-Y") ; ?>
                                        </td>
                                        <!-- <td class="px-4 py-3 text-sm">
                      <?php //echo $row['BXD_Ma']; 
                        ?>
                            ...
                            <div
                              ...
                              >
                                <img
                                  ...
                                  src="../img/Xe/ghe/<?php echo $row["X_Hinh"]; ?>"
                                  loading="lazy"
                                />
                                <div
                                ...
                                ></div>
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <div class="">
                                                <img width="50%" class="" src="../img/Xe/ghe/<?php echo $row["X_Hinh"]; ?>" loading="lazy" />
                                        ...
                                        <td class="px-4 py-3">
                                            ...
                                            <div class="flex items-center space-x-4 text-sm">
                                                <form action="" method="post">
                                                    <a class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Sua" href="capnhatxe.php?this_id=<?php echo $row['X_Ma'] ?> ">
                                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
                                                            <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path>
                                                        </svg>

                                                    </a>
                                                    <input type="hidden" name="X_Ma" value="<?php echo $row['X_Ma']; ?>" />
                                                </form>

                                                <!-- XOÁ -->

                                                <form action="" method="post">
                                                    <a style="color: red;" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" aria-label="Xoa" class="btn btn-info btn-sm" href="xoaxe.php?this_id=<?php echo $row['X_Ma'] ?> ">
