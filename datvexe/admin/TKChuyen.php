      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full pb-16 overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <!-- CTA -->
            <?php
            // Truy vấn cơ sở dữ liệu để tính tổng doanh thu của các sản phẩm
            $sql = "SELECT b.C_Ma as ch, c.TC_Ten as chuyen, count(a.C_Ma) AS tansuat FROM tuyenchay c, phieudatve a, chuyen b where a.C_Ma=b.C_Ma and c.TC_Ma=b.TC_Ma  GROUP BY a.C_Ma ";
            ...
            while($row = $result->fetch_assoc()) {
              // $data[$x]= $row["tansuat"] ;
                $data[$row["ch"]] = $row["tansuat"];
                // $data[$row["chuyen"]] = $row["tansuat"];
            ...
            <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
              ...
              <div class="text-center">Biểu đồ tròn thống kê tỷ lệ đặt của các chuyến xe</div>
              <script>
