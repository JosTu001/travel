...
if (isset($_POST['sua'])) {
    $id=$_POST['G_Ma'];
        ...
        echo "<script>alert('Cập nhật ghế thành công!');</script>"; 
    header('Refresh: 0;url=QLGhe.php');
            ...
            <main class="h-full pb-16 overflow-y-auto">
                    ...
                    <div class="container px-6 mx-auto grid">
                        ...
                        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            ...
                            <?php
                            $sql = "SELECT * FROM xe a, ghe b  where a.X_Ma=b.X_Ma and  b.G_Ma = " . $this_id;
                            ...
                            ?>
                         <form action="suaghe.php" method="post" enctype="multipart/form-data">
                            <label class="block mt-4 text-sm">
                                <span class="text-gray-700 dark:text-gray-400">
                                    Mã số ghế
                                </span>
                                <input type="text" name="ghe" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["G_MaSoGhe"];
                                                                                                                                                                                                                                                                                    ?>" />
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <select name="trangthai" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-multiselect focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                                    <option value="<?php echo $row['G_TrangThai']; ?>"><?php echo $row['G_TrangThai']; ?></option>
