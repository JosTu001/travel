...
$row = mysqli_fetch_assoc($query);
    ...
    if(isset($_POST['capnhatKM'])){
        ...
        $sql="UPDATE khuyenmai set KM_Ten='$ten',KM_NoiDung='$nd',KM_Hinh='$img',KM_TyLeGG='$TL',KM_NgayBD='$BD',KM_NgayKT='$KT',TC_Ma='$tuyen' where KM_Ma=".$this_id;
      ...
      <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
        ...
        <main class="h-full pb-16 overflow-y-auto">
         <form enctype="multipart/form-data" action=""  method="post">
            ...
            <?php
             $sql="SELECT * FROM khuyenmai a, tuyenchay b where a.TC_Ma =b.TC_Ma and KM_Ma = ".$this_id;
             $query =mysqli_query($conn,$sql);
             $row = mysqli_fetch_assoc($query);
            ?>
            ...
            >
              ...
              <label class="block mt-4 text-sm">
                ...
                <input type="datetime-local" name="KM_NgayBD"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  VALUE="<?php echo $row['KM_NgayBD'] ;?>"
                />
              </label>
              ...
              <label class="block mt-4 text-sm">
                ...
                <input type="datetime-local" name="KM_NgayKT"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                  value="<?php echo $row['KM_NgayKT'] ;?>"
                />
              </label>
