...
// echo $this_id;
$sql = "SELECT * FROM nhanvien a, vaitro b where a.VT_Ma=b.VT_Ma and NV_Ma = " . $this_id;
...
if (isset($_POST['capnhatNV'])) {
    ...
    $sql = "UPDATE nhanvien set NV_Ten='$name',NV_GioiTinh='$gioitinh',NV_NgaySinh='$ngaysinh',NV_Sdt='$sdt',NV_Email='$email',NV_DiaChi='$diachi',NV_Hinh='$img', VT_Ma='$chucvu' where NV_Ma=" . $this_id;
              ...
              Tên tuyến
                        ...
                        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            <label class="block text-sm">
                                ...
                                <input name="KH_Ten" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["NV_Ten"]; ?>" />
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <select name="chucvu" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-multiselect focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input name="KH_Gioitinh" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["NV_GioiTinh"]; ?>" />
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input name="KH_Ngaysinh" type="date" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["NV_NgaySinh"]; ?>" />
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input name="KH_sdt" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo  $row["NV_Sdt"]; ?>" />
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input name="KH_email" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["NV_Email"]; ?>" />
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input name="KH_Diachi" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["NV_DiaChi"]; ?>" />
                            </label>
                            ...
                            <div class="text-center"><br>
                                <button name="capnhatNV" class="  px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                                    Cập nhật
                                </button>
                            </div>
