...
$sql = "SELECT * FROM chitietphieudat c,phieudatve a, ghe b  where c.PD_Ma=a.PD_Ma and c.G_Ma=b.G_Ma and  a.PD_Ma = " . $this_id;
...
while ($r = mysqli_fetch_array($re)) {
  ...
  if (isset($_POST['suatt'])) {
    ...
    $sql = "UPDATE phieudatve set PD_TrangThai='$trangthai'where PD_Ma='" . $r["PD_Ma"] . "'";
...
<?php $sl = "select * from phieudatve, chitietphieudat,ghe where phieudatve.PD_Ma=chitietphieudat.PD_Ma and chitietphieudat.G_Ma=ghe.G_Ma and phieudatve.C_Ma ='" . $row['C_Ma'] . "' and PD_NgayDat='" . $row['PD_NgayDat'] . "'";
...
if (isset($_POST['suatt'])) {
    ...
    if ($ro['PD_TrangThai'] == 1) {
      $s = "UPDATE ghe set G_TrangThai='1' where G_Ma= '" . $ro["G_Ma"] . "'";
      mysqli_query($conn, $s);
    
    }
    //Đã hoàn thành
    if ($ro['PD_TrangThai'] == 2) {
  ...
  echo "<script>alert('Cập nhật phiếu đặt thành công!');</script>"; 
  header('Refresh: 0;url=QLDV.php');
          ...
          <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <form action="#" method="post" enctype="multipart/form-data">
              ...
              <label class="block mt-4 text-sm">
                ...
                <select name="trangthai" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-multiselect focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                  <option value="<?php echo $row['PD_TrangThai']; ?>"><?php echo $row['PD_TrangThai']; ?></option>

                  <option value="0">Đẵ huỷ</option>
              ...
              <div class="text-center"><br>
                ...
                <button name="suatt" type="submit" class="  px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                  Cập nhật
                </button>
              </div>
            </form>
