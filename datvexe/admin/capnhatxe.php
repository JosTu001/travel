...
// echo $this_id;
$sql="SELECT * FROM xe where X_Ma = ".$this_id;
...
if (isset($_POST['suaxe'])) {
    ...
    $sql = "UPDATE xe set LX_Ma='$loai', X_Hieu='$hieu', X_MauSac='$mau', X_NamSX='$namsx', X_BienSo='$bienso',X_Hinh='$img'where X_Ma=" . $this_id;
    mysqli_query($conn, $sql);
    move_uploaded_file($img_tmp_name, '../img/Xe/ghe/' . $img);

    header('location:QLXe.php');
    ob_end_flush();
}
            ...
            <main class="h-full pb-16 overflow-y-auto">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="container px-6 mx-auto grid">
                        ...
                        <?php
                        $sql = "SELECT * FROM xe a, loaixe b where a.LX_Ma=b.LX_Ma and  X_Ma = " . $this_id;
                        $query = mysqli_query($conn, $sql);
                        $row = mysqli_fetch_assoc($query);
                        ?>
                        ...
                        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            <label class="block text-sm">
                                <span class="text-gray-700 dark:text-gray-400">Loại xe</span>
                                <select name="loai" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-multiselect focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                                    <option value="<?php echo $row['LX_Ma']; ?>"><?php echo $row["LX_Ten"]; ?> </option>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input type="text" name="bienso" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["X_BienSo"];
                                                                                                                                                                                                                                                                                                    ?>" />
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input type="date" name="namsx" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["X_NamSX"];
                                                                                                                                                                                                                                                                                                    ?>" />
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input type="text" name="mau" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["X_MauSac"];
                                                                                                                                                                                                                                                                                                        ?>" />
                            </label>

                            <label class="block text-sm">
                                <span class="text-gray-700 dark:text-gray-400">Nhãn hiệu</span>
                                <input name="hieu" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["X_Hieu"]; ?>" />
                            </label>
                            ...
                            <div class="text-center"><br>
                                <button name="suaxe" class="  px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                                    Cập nhật
                                </button>
                            </div>
                        </div>
