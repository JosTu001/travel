...
if (isset($_POST['sua'])) {
        ...
        $sql = "UPDATE loaixe set LX_Ten='$loai', LX_SLGhe='$sl' where LX_Ma=$id";
        mysqli_query($conn, $sql);
    
        header("location:QLLX.php");
    }
            ...
            <main class="h-full pb-16 overflow-y-auto">
                    ...
                    <div class="container px-6 mx-auto grid">
                        ...
                        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            ...
                            <?php
                            $sql = "SELECT * FROM loaixe where  LX_Ma = $id";
                            $query = mysqli_query($conn, $sql);
                            $row = mysqli_fetch_assoc($query);
                           
                          
                            ?>
                         <form action="suaLX.php" method="post" enctype="multipart/form-data">
                            <label class="block mt-4 text-sm">
                                <span class="text-gray-700 dark:text-gray-400">
                                   Tên loại xe
                                </span>
                                <input type="text" name="ten" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["LX_Ten"];
                                                                                                                                                                                                                                                                                    ?>" />
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input type="text" name="sl" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["LX_SLGhe"]; ?>" />
