...
<?php
    ...
    if (isset($_POST['themBX'])) {
        ...
        $sql = "INSERT INTO benxe (BX_Ten, H_Ma) VALUES('$ten','$huyen') ";
        ...
        <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen}">
            ...
            <div class="flex flex-col flex-1 w-full">
                ...
                <main class="h-full pb-16 overflow-y-auto">
                    <form enctype="multipart/form-data" action="themBX.php" method="post">
                        <div class="container px-6 mx-auto grid">
                            ...
                            <label class="block mt-4 text-sm">
                                <span class="text-gray-700 dark:text-gray-400"> Tên bến xe</span>                          
                                <input type="text" name="ten" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />
                            </label>

                            <label for="tinh" class="block mt-4 text-sm">
                            ...
                            <div class="text-center"><br>
                                <button name="themBX" class="  px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                                Thêm
                            </button>
                            </div>
