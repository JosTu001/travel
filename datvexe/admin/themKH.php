...
<?php
   ...
   if(isset($_POST['themKH'])){
        ...
        $sql="INSERT INTO khachhang(KH_Ten, KH_GioiTinh,KH_NgaySinh,KH_Sdt,KH_Email,KH_DiaChi,KH_Hinh,password,repassword) VALUES('$name','$gioitinh','$ngaysinh','$sdt','$email','$diachi', '$img','$pass','$repass')";
