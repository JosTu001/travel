...
<?php
    ...
    if (isset($_POST['themLX'])) {
        ...
        $sql = "INSERT INTO loaixe (LX_Ten, LX_SLGhe) VALUES('$loai','$sl') ";
    ...
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen}">
        ...
        <div class="flex flex-col flex-1 w-full">
            ...
            <main class="h-full pb-16 overflow-y-auto">
                <form enctype="multipart/form-data" action="themLX.php" method="post">
                    <div class="container px-6 mx-auto grid">
                      ...
                      <label class="block mt-4 text-sm">
                          ...
                          Số lượng ghế
                            ...
                            <input type="text" name="sl" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" />
                      </label>
                        ...
                        <div class="text-center"><br>
                            <button name="themLX" class="  px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                                Thêm
                            </button>
                        </div>
