...
<?php
   ...
   if(isset($_POST['themTX'])){
        ...
        $sql="INSERT INTO taixe(TX_Ten, TX_GioiTinh,TX_NgaySinh,TX_Sdt,TX_GPLX,TX_DiaChi,TX_Hinh,TX_Password,TX_Repass) VALUES('$name','$gioitinh','$ngaysinh','$sdt','$gplx','$diachi', '$img','$pass','$repass')";
...
<body>
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen}">
        ...
        <main class="h-full pb-16 overflow-y-auto">
         <form action="themTX.php"  method="post" enctype="multipart/form-data">
         <div class="container px-6 mx-auto grid">
            ...
            >
              ...
              <label class="block mt-4 text-sm">
                ...
                <input name="TX_Ngaysinh" type="date"
                  class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
