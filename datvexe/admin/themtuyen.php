...
if (isset($_POST['them'])) {
  ...
  $sql = "INSERT INTO tuyenchay(TC_Ten,TC_Hinh,TC_ThoiGianTao) VALUES('$ten','$img',now())";
  ...
  <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen}">
    ...
    <div class="flex flex-col flex-1 w-full">
      ...
      <main class="h-full pb-16 overflow-y-auto">
        <form enctype="multipart/form-data" action="themtuyen.php" method="post">
            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
              <label class="block text-sm">
                ...
                <select  name="diemdi" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-multiselect focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                                    <option style="text-align: center;" value="">Chọn điểm đi</option>
                                ...
                                <select name="diemden" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-multiselect focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                                    <option  style="text-align: center;" value=" ?>">Chọn điểm đến</option>
              ...
              <!-- <label class="block mt-4 text-sm">
                ...
                <input type="date" name="TC_Thoigian"
              ...
              <div class="text-center"><br>
                <button name="them" class="  px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                  Thêm
                </button>
              </div>
