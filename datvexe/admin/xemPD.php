  ...
  <div class="flex h-screen bg-gray-50 dark:bg-gray-900" :class="{ 'overflow-hidden': isSideMenuOpen}">
    ...
    <div class="flex flex-col flex-1 w-full">
      ...
      <main class="h-full pb-16 overflow-y-auto">
        ...
        $sql = "SELECT * FROM  khachhang b,phieudatve a,chitietphieudat k, xe c, ghe d, tuyenchay f, loaixe g, taixe i, chuyen e , thanhtoan s WHERE k.PD_Ma=a.PD_Ma and s.PD_Ma=a.PD_Ma and e.TC_Ma=f.TC_Ma and a.KH_Ma=b.KH_Ma AND a.C_Ma=e.C_Ma and k.G_Ma=d.G_Ma and d.X_Ma=c.X_Ma and c.LX_Ma=g.LX_Ma  and a.PD_Ma=" . $this_id;
        $result = mysqli_query($conn, $sql);
        ...
        <div class="container px-6 mx-auto grid">
         ...
         <h2 class="text-center" ><b >Trạng thái:<span style="color: red;"> <?php echo $row["PD_TrangThai"]; ?></span></b></h2>
         <label class="block mt-4 text-sm text-center">
          ...
          <div class="flex items-center  p-6 bg-gray-50 dark:bg-gray-900">
            <div class="flex-1 h-full mx-auto  bg-white  shadow-xl dark:bg-gray-800">
              ...
              <div class="flex flex-col overflow-y-auto md:flex-row">
                <div style="padding-top: 5rem;padding-left: 3rem" class="h-32 md:h-auto md:w-1/2">
                  <img width="100%" class="" src="../img/Xe/ghe/<?php echo $row["TC_Hinh"]; ?>" loading="lazy" />
                </div>
                <div class=" items-center justify-center p-6 sm:p-12 md:w-1/2">


                  <h3 ><b>Tên chuyến: </b><?php echo $row["TC_Ten"]; ?></h3>
                  <ul class="list-unstyled booking-info">
                    ...
                    <li><b>Thời gian đến: </b><?php $date = date_create($row["C_ThoiGianDen"]);
                        echo date_format($date, "d-m-Y H:s:i") ; ?></li>
                    <li><b>Giá vé: </b><?php echo number_format($row["C_DonGia"]); ?> VND/ Ghế</li>
                    <li><b>Ghế: </b><?php $sl = "select * from  chitietphieudat,ghe where chitietphieudat.G_Ma=ghe.G_Ma and chitietphieudat.PD_Ma ='" . $row['PD_Ma'] . "'";
                                    $res = mysqli_query($conn, $sl);
                                    while ($ro = mysqli_fetch_array($res)) { ?>
                        <?php echo $ro["G_MaSoGhe"]; ?> &nbsp;

                      <?php } ?></li>
                    <li><b>Tổng tiền: </b><?php echo number_format($row["PD_TongTien"]); ?> (VNĐ)</li>
                    <li><b>Phương thức thanh toán: </b><?php echo $row["TT_PhuongThuc"]; ?></li>

                    <li><b>Xe: </b><?php echo $row["X_Ma"]; ?></li>
                    <li><b>Loại xe: </b><?php echo $row["LX_Ten"]; ?></li>

                    <li><b>Ngày đặt vé: </b><?php $date = date_create($row["PD_NgayDat"]);
                        echo date_format($date, "d-m-Y H:s:i") ; ?></li>
                    <p><b>Thông tin khách hàng:</b></p>

                    <li><b>Tên khách hàng: </b> <?php echo $row["CT_TenKH"]; ?>
                    <li><b>Email: </b><?php echo $row["CT_EmailKH"]; ?></li>
                    <li><b>Số điện thoại: </b><?php echo $row["CT_SdtKH"]; ?></li>


                    <li><b>Điểm lên xe: </b><?php echo $row["PD_DiemDon"]; ?></li>
                    <li><b>Thông tin tài xế: </b> <?php echo $row["TX_Ten"]; ?><span class="line"></span></li>


                  </ul>

                  <!-- You should use a button here, as the anchor is only used for the example  -->
                  <a class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" href="capnhatTT.php?this_id=<?php echo $row['PD_Ma'] ?> ">
                    SỬA
                  </a>
                </div>
              </div>
