...
<?php
   ...
   if(isset($_POST['cn'])){
        ...
        $sql="UPDATE khachhang set KH_Ten='$name',KH_Email='$email',KH_Sdt='$sdt',KH_NgaySinh='$ngaysinh',KH_GioiTinh='$gioitinh',KH_DiaChi='$diachi',KH_Hinh='$img' where KH_Ma=".$this_id;
                        ...
                        <div style="padding-left:30%;padding-right:30% ;margin: 1rem auto; max-width: 60rem; padding: 1rem;">
                        	...
                        	<div class="flex-content">
                                <div class="custom-form custom-form-fields">
                                    <h3 class="text-center"><B>CHỈNH SỬA</B></h3>
                                   
                                    <form method="post" enctype="multipart/form-data">
                                            
                                        <div class="form-group">
                                             <input name="name" type="text" class="form-control" placeholder="Họ tên" VALUE="<?php  echo $row["KH_Ten"]; ?>"  required/>
                                             <span><i class="fa fa-user"></i></span>
                                        </div>

                                        <div class="form-group">
                                             <input name="gioitinh" type="text" class="form-control" placeholder="Giới tính"  VALUE="<?php  echo $row["KH_GioiTinh"]; ?>" required/>
                                             <span><i class="fa fa-venus-mars"></i></span>
                                        </div>

                                        <div class="form-group">
                                             <input  name="ngaysinh" type="date" class="form-control" placeholder="Ngày sinh"  VALUE="<?php  echo $row["KH_NgaySinh"]; ?>"  required/>
                                             <span><i class="fa fa-calendar"></i></span>
                                        </div>

                                        <div class="form-group">
                                             <input name="sdt" type="number" class="form-control" placeholder="Số điện thoại" VALUE="<?php  echo $row["KH_Sdt"]; ?>" required/>
                                             <span><i class="fa fa-phone"></i></span>
                                        </div>
        
                                        <div class="form-group">
                                             <input name="email" type="email" class="form-control" placeholder="Email" VALUE="<?php  echo $row["KH_Email"]; ?>"  required/>
                                             <span><i class="fa fa-envelope"></i></span>
                                        </div>                                      
        
                                        <div class="form-group">
                                             <input  name="diachi" type="text" class="form-control" placeholder="Địa chỉ"  VALUE="<?php  echo $row["KH_DiaChi"]; ?>"  required/>
                                             <span><i class="fa fa-map-marker"></i></span>
                                        </div>
                                        
                                        <div class="form-group">
                                        <Label>Hình ảnh</Label>
                                        <img name="img" src="img/Xe/ghe/<?php  echo $row["KH_Hinh"];?>" class="img-responsive" alt="user-img" /> <br>
                                             
                                        </div>

                                        <div class="form-group">
                                        
                                             <input  name="img" type="file" class="form-control" VALUE="<?php  echo $row["KH_Hinh"]; ?> " />
                                        ...
                                        <button name="cn"  class="btn btn-orange btn-block">Cập nhật</button>
