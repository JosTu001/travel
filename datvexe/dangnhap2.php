...
<?php
   ...
   if(isset($_POST['datmk'])){
        ...
        if($passnew != $repass){
            ...
            $sql="UPDATE khachhang set password='$passnew',repassword='$repass'where KH_Ma=".$this_id ;
                        	...
                        	<div class="flex-content">
                                <div class="custom-form custom-form-fields">
                                    ...
                                    <form method="post" >
                                        ...
                                        <div class="form-group">
                                             <input name="passnew" type="password" class="form-control" placeholder="Mật khẩu mới" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" title="Mật khẩu phải là chử hoặc số và có độ dài 8 ký tự" required/>
                                        ...
                                        <button name="datmk"  class="btn btn-orange btn-block">Submit</button>
                                    </form>
