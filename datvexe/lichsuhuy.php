                                ...
                                <div class="col-xs-12 col-sm-10 col-md-10 dashboard-content booking-trips">
                                    ...
                                    <div class="dashboard-listing booking-listing">
                                        <div class="dash-listing-heading text-center">
                                            ...
                                            <a style="text-decoration: none" href="lichsuhuy.php" class="text-center"><b >VÉ ĐÃ HUỶ</b> </a>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                $sql = "SELECT * FROM  khachhang b,phieudatve a,chitietphieudat k, xe c, ghe d, tuyenchay f, loaixe g, taixe i, chuyen e , thanhtoan s WHERE k.PD_Ma=a.PD_Ma and s.PD_Ma=a.PD_Ma and e.TC_Ma=f.TC_Ma and a.KH_Ma=b.KH_Ma AND a.C_Ma=e.C_Ma and k.G_Ma=d.G_Ma and d.X_Ma=c.X_Ma and c.LX_Ma=g.LX_Ma and KH_Email='$email' and PD_TrangThai = '0' group by PD_NgayHuy order by PD_NgayHuy DESC;";
