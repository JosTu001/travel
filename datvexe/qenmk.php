   ...
   if(isset($_POST['quenmk'])){
        ...
        if(mysqli_num_rows($result) == 1)
        {
           ...
           // header('location:quenmk.php');
			...
			header('Refresh: 0;url=quenmk.php');
        }
        else{
                        	...
                        	<div class="flex-content">
                                <div class="custom-form custom-form-fields">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                             <input name="email" type="text" class="form-control" placeholder="Email đăng ký" VALUE=""  required/>
                                             <span><i class="fa fa-envelope"></i></span>
                                        </div>

                                        <button name="quenmk"  class="btn btn-orange btn-block">Gửi</button>
