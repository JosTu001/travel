...
<?php
   ...
   if(isset($_POST['suamk'])){
        ...
        $sql="SELECT * FROM khachhang where password= '$passold' and KH_Ma=".$this_id;  
        ...
        if(mysqli_num_rows($result) == 1)
        {
            ...
            $sql="UPDATE khachhang set password='$newpass',repassword='$repass'where KH_Ma=".$this_id ;
                        	...
                        	<div class="flex-content">
                                <div class="custom-form custom-form-fields">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                             <input name="passold" type="password" class="form-control" placeholder="Mật khẩu cũ"  pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" title="Mật khẩu phải là chử hoặc số và có độ dài 8 ký tự"  required/>
                                             <span><i class="fa fa-lock"></i></span>
                                        </div>

                                        <div class="form-group">
                                             <input name="newpass" type="password" class="form-control" placeholder="Mật khẩu mới"  pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" title="Mật khẩu phải là chử hoặc số và có độ dài 8 ký tự" required/>
                                             <span><i class="fa fa-lock"></i></span>
                                        </div>

                                        <div class="form-group">
                                             <input name="repass" type="password" class="form-control" placeholder="Nhập lại mật khẩu mới"  pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$" title="Mật khẩu phải là chử hoặc số và có độ dài 8 ký tự" required/>
                                             <span><i class="fa fa-lock"></i></span>
                                        </div>
                                  
                                        <button name="suamk"  class="btn btn-orange btn-block">Cập nhật</button>
                                    </form>
