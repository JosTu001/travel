...
// echo $this_id;
$sql = "SELECT * FROM taixe a, chuyen b where a.TX_Ma=b.TX_Ma and a.TX_Ma = " . $this_id;
$query = mysqli_query($conn, $sql);
$row = mysqli_fetch_assoc($query);


if (isset($_POST['capnhatTX'])) {
    //$id = "";
    $name = $_POST['TX_Ten'];
    $gioitinh = $_POST['TX_Gioitinh'];
    $ngaysinh = $_POST['TX_Ngaysinh'];
    $gplx = $_POST['TX_GPLX'];
    $sdt = $_POST['TX_sdt'];
    $diachi = $_POST['TX_Diachi'];
    $img = $_FILES['img']['name'];
    //lay duong dan anh
    ...
    $sql = "UPDATE taixe set TX_Ten='$name',TX_GioiTinh='$gioitinh',TX_NgaySinh='$ngaysinh',TX_Sdt='$sdt',TX_GPLX='$gplx',TX_DiaChi='$diachi',TX_Hinh='$img' where TX_Ma = ". $this_id."" ;
                    ...
                    <div class="container px-6 mx-auto grid">
                        ...
                        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                            <label class="block text-sm">
                                ...
                                <input name="TX_Ten" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["TX_Ten"]; ?>" />
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input name="TX_Gioitinh" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["TX_GioiTinh"]; ?>" />
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input name="TX_Ngaysinh" type="date" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["TX_NgaySinh"]; ?>" />
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input name="TX_sdt" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo  $row["TX_Sdt"]; ?>" />
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input name="TX_GPLX" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["TX_GPLX"]; ?>" />
                            </label>
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input name="TX_Diachi" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" VALUE="<?php echo $row["TX_DiaChi"]; ?>" />
                            </label>
                            ...
                            <div class="text-center"><br>
                                <button name="capnhatTX" class="  px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                                    Cập nhật
                                </button>
                            </div>
