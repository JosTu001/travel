            ...
            <div class="flex-1 h-full mx-auto  bg-white  shadow-xl dark:bg-gray-800">
              ...
              <div class="flex flex-col overflow-y-auto md:flex-row">
                <div class="h-32 md:h-auto md:w-1/2">
                  <img width="100%" class="" src="../img/Xe/ghe/<?php echo $row["A_Hinh"]; ?>" loading="lazy" />
                </div>
                <div class=" items-center justify-center p-6 sm:p-12 md:w-1/2">


                  <h3><b>Họ tên: </b><?php echo $row["A_Ten"]; ?></h3>
                  <ul class="list-unstyled booking-info">
                    <li><b>Ngày sinh: </b><?php $date = date_create($row["A_NgaySinh"]);
                        echo date_format($date, "d-m-Y") ; ?></li>
                    <li><b>Giới tính: </b><?php echo $row["A_GioiTinh"]; ?></li>
                    <li><b>Số điện thoại: </b><?php echo $row["A_SDT"]; ?> </li>
                    <li><b>Email: </b><?php echo $row["A_Email"]; ?> </li>
                    <li><b>Địa chỉ: </b> <?php echo $row["A_DiaChi"]; ?></li></li>
