         ...
         <h2 style="font-size:18px; color:darkblue" class="text-center" ><i class="fa fa-calendar" ></i> <b >Lịch làm việc</b></h2>
          ...
          <div class="flex items-center  p-6 bg-gray-50 dark:bg-gray-900">
            ...
            <?php
                           ...
                           <th style="width: 10%;text-align:center;padding:20px;">Thời gian</th>
                            <th style="width: 14%;text-align:center;">Chuyến</th>
                       ...
                       <td><?php echo $i ?></td>
                       <td><?php $date = strtotime($ro["C_ThoiGianXP"]); echo date("N", $date) ?></td>
                        <td ><?php $date=date_create($ro["C_ThoiGianXP"]); echo date_format( $date, "N d-m-Y (H:i:s)");   ?> </td>
                        ...
                        <td ><a href="chitiet.php?this_id=<?php echo $ro['C_Ma'] ?>" style="color: blue;text-decoration: none; cursor:pointer"><b>In <i class="fa fa-print"></i></b></a> </td>
